...
function moxy_help() {
    ...
    log " ${GREEN}◦${RESET} ${BOLD}lxc${RESET} [ ${DIM}distro@version${RESET} ] - ${ITALIC}${DIM}create a new LXC container${RESET}"
    log " ${GREEN}◦${RESET} ${BOLD}vm${RESET} [ ${DIM}distro@version${RESET} ] - ${ITALIC}${DIM}create a new Virtual Machine${RESET}"
